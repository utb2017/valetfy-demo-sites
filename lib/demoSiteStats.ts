import type { DemoSiteStats } from "@/lib/demoSiteTypes";
...
export function emptyDemoSiteStats(): DemoSiteStats {
  return { views: 0, book: 0, claim: 0, text: 0, call: 0, leads: 0 };
}
...
export function normalizeDemoSiteStats(raw: unknown): DemoSiteStats {
  ...
  for (const key of [...DEMO_SITE_STAT_EVENTS, "leads"] as const) {
